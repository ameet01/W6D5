...
var Root = function (_React$Component) {
  ...
  function Root() {
    ...
    _this.names = ['Joe', 'Anish', 'Maxwell', 'Harish', 'Jennifer', 'Ameet'];
    return _this;
  }
  ...
  _createClass(Root, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_search2.default, { names: this.names }),
        _react2.default.createElement(_weather2.default, null),
        _react2.default.createElement(_tabs2.default, { className: 'tabs', data: this.tabs })
      );
    }
  }]);
...
var Tabs = function (_React$Component) {
  ...
  _createClass(Tabs, [{
    ...
    value: function click(event) {
      var currentTab = parseInt(event.target.id);
      var children = Array.from(event.currentTarget.children);
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'p',
            null,
            this.props.data[this.state.currentTab].content
          )
        )
      );
    }
...
var Weather = function (_React$Component) {
  ...
  _createClass(Weather, [{
    ...
    key: 'getWeatherData',
    value: function getWeatherData(location) {
      var _this2 = this;
      ...
      var apiKey = '9b989fdfe5aac8208da67b8bc1a6044e';
      ...
      if (this.state.weather) {
        content = _react2.default.createElement(
          ...
          _react2.default.createElement(
            'p',
            null,
            parseInt(this.state.weather.main.temp) * (9 / 5) - 459.67,
            ' degrees'
          )
        );
      } else {
...
var Search = function (_React$Component) {
  ...
  function Search(props) {
    ...
    _this.removeText = _this.removeText.bind(_this);
  ...
  _createClass(Search, [{
    ...
    value: function filter(event) {
      ...
      if (text === "") {
        ...
        this.names = this.props.names.filter(function (el) {
          return el.toLowerCase().includes(text.toLowerCase().trim());
        });
      }
    ...
    key: "removeText",
    value: function removeText(event) {
      event.target.value = "";
    }
  }, {
    key: "render",
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            "label",
            null,
            _react2.default.createElement("input", { className: "searchbar", onClick: this.removeText, onChange: this.filter, type: "text", defaultValue: "search..." })
          )
        ),
        _react2.default.createElement(
          "div",
